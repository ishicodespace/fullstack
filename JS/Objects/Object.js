...
//get values
console.log(student["name"]); //object["key"] square brackets are mostly used when variable is used as key
...
console.log(obj); //gives error cause dot does not convert number to string
